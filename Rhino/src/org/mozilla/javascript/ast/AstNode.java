...
//     }
    ...
    /**
	 * Shoreray: Added to help construct source-level control flow graph.
	 * 
	 * @return True if the AstNode instance represents a single source-level
	 *         statement which is suitable for regression test selection.
	 */
     ...
     * Shoreray: Added to help construct source-level control flow graph.
     * 
     * @return	True if the language construct represented by this node will
     * 			cause a jump in the control flow.
     */
    public boolean isJumpStatement(){
    	if(isSingleStatement() || isStructuralNode()){
    		return false;
    	}else{
	 ...
	 * Shoreray: Added to help construct source-level control flow graph.
	 * 
	 * @return True if the AstNode instance represents something with a
	 *         "structure", such as the body of a while loop.
	 */
